...
import { loadRuntimeContext as loadCoreRuntimeContext } from "../core/token.mjs";
import { addBlacklist, deleteDeployment, fetchAllImages, fetchGpuStock, listContainers, listDeployments, listEvents, listBlacklists, setReplicas, stopContainer, stopDeployment, } from "./api.mjs";
    ...
    try {
        ...
        switch (command) {
            ...
            case "gpu-stock": {
                ...
                const filters = filtersPath ? await readJsonFile(filtersPath) : undefined;
                const stockOptions = {};
