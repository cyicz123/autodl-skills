export const VALID_DEPLOYMENT_TYPES = ["ReplicaSet", "Job", "Container"];
...
export function validateElasticConfig(config) {
    const errors = [];
...
function pushRangeError(errors, template, fromKey, toKey) {
