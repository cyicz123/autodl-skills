...
import { createInstance, getSnapshot, getStatus, listImages, listInstances, powerOff, powerOn, releaseInstance, saveImage, } from "./api.mjs";
    ...
    try {
        ...
        switch (command) {
            case "create": {
                ...
                printJson(await createInstance(apiContext, await readJsonFile(configPath)), io);
                return 0;
            }
            case "snapshot":
